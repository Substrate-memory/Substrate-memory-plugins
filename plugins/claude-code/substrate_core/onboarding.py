...
def resolve_agent_name() -> str:
    ...
    # HOST-HOME PATCH (claude-code): also accept CLAUDE_PROFILE alongside
    # SUBSTRATE_AGENT_NAME/HERMES_PROFILE for the approval-page display name.
    candidate = (
        os.environ.get("SUBSTRATE_AGENT_NAME")
        or os.environ.get("CLAUDE_PROFILE")
...
# HOST-HOME PATCH (claude-code): helper implementing the multi-host spec
...
class OnboardingManager:
    ...
    def _complete(self, value: dict[str, Any]) -> bool:
        ...
        try:
            ...
            # HOST-HOME PATCH (claude-code): mirror the key into the 0600
