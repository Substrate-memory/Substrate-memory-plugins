...
def resolve_agent_name() -> str:
    ...
    # OPENCLAW HOST-HOME PATCH (vendored copy): HERMES_PROFILE -> OPENCLAW_AGENT_NAME.
    candidate = os.environ.get("SUBSTRATE_AGENT_NAME") or os.environ.get("OPENCLAW_AGENT_NAME") or ""
