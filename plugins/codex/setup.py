#!/usr/bin/env python3
"""One-prompt setup and credential migration for the Substrate Codex plugin."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Connect the active Codex profile to Substrate")
